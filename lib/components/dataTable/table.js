...
export default function () {
  ...
  return /*#__PURE__*/React.createElement(Paper, {
    ...
    "aria-label": "table"
  }, /*#__PURE__*/React.createElement(TableHead, null, /*#__PURE__*/React.createElement(TableRow, null, store.columns != null && store.columns.map((column, index) => {
    return /*#__PURE__*/React.createElement(TableCell, {
      key: column.name,
      className: clsx(classes.tableCell, index === 0 ? classes.stikyHead : null, store.config != null && index === store.config.columns.length ? classes.fixWidth : null),
